...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_GLDisplay_t, stringdata) + ofs \
...
const QMetaObject GLDisplay::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_GLDisplay.data,
      qt_meta_data_GLDisplay,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *GLDisplay::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_GLDisplay.stringdata))
